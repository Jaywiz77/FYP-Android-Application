...
//    }
    ...
    public void buttonDisplayLogic(){
        ...
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP && hasUsageStatsPermission(this) && isBluetoothEnabled && hasCoarseLocationPermission() && hasLocationServiceEnabled()) {
